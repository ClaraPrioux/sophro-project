  ...
  return (
    <div className="p-8 bg-white m-4 mt-0 md:m-12 md:mt-0 text-green">
      ...
      <p className="text-lg mb-8 italic">
        Pour toute information, vous pouvez me contacter, réserver directement
        en ligne en cliquant sur ce bouton, ou me joindre par téléphone ou par
        message.
      </p>
      <div className="container mx-auto p-6">
        ...
        <div className="bg-white shadow-md rounded-lg p-12 mb-6 text-center md:w-2/3 mx-auto  border-2 border-lightGreen">
          ...
          <a
            href="https://votre-site-de-reservation.com" // Remplacez par le lien de votre site de réservation
            target="_blank"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col items-center shadow-md rounded-lg p-6  border-2 border-lightGreen">
            ...
            <p className="text-lg">rosy-sophro@ovh.com</p>{" "}
          ...
          <div className="flex flex-col items-center shadow-md rounded-lg p-6  border-2 border-lightGreen">
            ...
            <p className="text-lg m-2">+33 6 00 00 00 00</p>{" "}
